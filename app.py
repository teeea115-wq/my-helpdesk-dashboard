...
<style>
    ...
    div[data-baseweb="select"] > div { background-color: #F8FAFC !important; border: 1px solid #CBD5E1 !important; border-radius: 6px !important; }
...
try:
    ...
    # --- 💥 กราฟวงกลม 2 อัน (แก้ไม้ตาย: Margin 100px รอบทิศทาง) ---
    with donuts_zone:
        ...
        with col_pie1:
            ...
            # 💥 THE FIX: ให้ขอบกว้างๆ ไปเลย 100px ทุกด้าน และเพิ่มความสูงเป็น 500px ให้มีพื้นที่หายใจ!
            fig_status.update_layout(height=500, showlegend=False, margin=dict(t=100, b=100, l=100, r=100))
        ...
        with col_pie2:
            ...
            # 💥 THE FIX: เช่นเดียวกัน เพิ่มขอบ 100px ทุกด้าน!
            fig_sla.update_layout(height=500, showlegend=False, margin=dict(t=100, b=100, l=100, r=100))
